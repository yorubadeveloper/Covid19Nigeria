...
import 'package:Covid19Nigeria/Helpers/InformationSampleData.dart';
import 'package:Covid19Nigeria/Helpers/SymptomSampleData.dart';
  ...
  Future<void> fetchStats() async {
    try {
      ...
      chartData = <ChartSampleData>[
        ChartSampleData(x: 'Confirmed', y: stats['total_cases'], text: ''),
        ChartSampleData(x: 'Dead', y: stats['total_deaths'], text: ''),
        ChartSampleData(x: 'Recovered', y: stats['total_recovered'], text: ''),
      ];
      isloading1 = false;
      notifyListeners();
    } catch (e) {
    ...
    try {
      ...
      if(news['message'] == "success"){
        news["news"].forEach((element){
          if(element["image"] != null && element["summary"] != null){
            NewsSampleData articleModel = NewsSampleData(
                element["title"],
                element["source"],
                element["link"],
              element["image"],
